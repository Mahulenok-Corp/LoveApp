...
const { randomBytes, sign } = nacl;
import { CheckProofRequestDto } from "../../zod/schemas/ton.js";
import { tryParsePublicKey } from "./wrappers/wallets-data.js";

const tonProofPrefix = "ton-proof-item-v2/";
const tonConnectPrefix = "ton-connect";
const allowedDomains = ["t.me", "tonprison.xyz", "ton-connect.github.io", "localhost:5173"];
